...
import { searchPatient } from "../../services/appointments";
...
const PatientSearch = ({ onSelectPatient }) => {
    ...
    const onSearch = async () => {
        ...
        try {
            const res = await searchPatient({ name, dob, email, phone });
    ...
    return (
        <div className="box">
            ...
            <p className="hint">{selected ? `Selected: ${selected.name}` : "No patient selected"}</p>
        </div>
    );
